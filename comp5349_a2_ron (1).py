...
Original file is located at
    https://colab.research.google.com/drive/1Yc7Y3yWUA7H8-FxiqpsMMsB5jmUgISYV
...
new_qas_context_df = qas_context_df.select("context","qas.answers.text","qas.answers.answer_start","qas.is_impossible","qas.question")
new_qas_context_df.printSchema()
new_qas_context_df.show(3)

# convert the df into rdd
qas_context_rdd = new_qas_context_df.rdd
